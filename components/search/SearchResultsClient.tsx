...
interface SearchResultsClientProps {
    initialRecommendations: DocumentRecommendation[];
}

function SearchResults({ initialRecommendations }: SearchResultsClientProps) {
                ...
                <div className="flex gap-10">
                    ...
                    <aside className="w-[400px] shrink-0">
                        <div className="sticky top-24 space-y-6">
                            <RecommendationsWidget initialData={initialRecommendations} />
...
export default function SearchResultsClient({ initialRecommendations }: SearchResultsClientProps) {
    return (
        <Suspense fallback={<div className="min-h-screen flex items-center justify-center bg-mesh">
            ...
            <SearchResults initialRecommendations={initialRecommendations} />
        </Suspense>
    );
}
