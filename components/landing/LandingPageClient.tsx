...
import RecommendedForYou from "@/components/landing-new/RecommendedForYou";
...
export default function LandingPageClient({ initialRecommendations }: LandingPageClientProps) {
    ...
    return (
        <div className="relative min-h-screen w-full overflow-x-hidden bg-background">
            ...
            <main className="pt-16">
                ...
                <RecommendedForYou initialData={initialRecommendations} />
