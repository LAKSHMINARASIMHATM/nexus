module.exports = [
"[project]/node_modules/@elastic/elasticsearch/lib/api/api/indices.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
class Indices {
    ...
    async addBlock(params, options) {
        const { path: acceptedPath } = this[client_1.kAcceptedParams]['indices.add_block'];
    ...
    async analyze(params, options) {
        const { path: acceptedPath, body: acceptedBody, query: acceptedQuery } = this[client_1.kAcceptedParams]['indices.analyze'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? {
            ...userQuery
        } : {};
    ...
    async cancelMigrateReindex(params, options) {
        const { path: acceptedPath } = this[client_1.kAcceptedParams]['indices.cancel_migrate_reindex'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? {
            ...userQuery
        } : {};
    ...
    async clearCache(params, options) {
        const { path: acceptedPath } = this[client_1.kAcceptedParams]['indices.clear_cache'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? {
            ...userQuery
        } : {};
    ...
    async clone(params, options) {
        const { path: acceptedPath, body: acceptedBody, query: acceptedQuery } = this[client_1.kAcceptedParams]['indices.clone'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? {
            ...userQuery
        } : {};
    ...
    async close(params, options) {
        const { path: acceptedPath } = this[client_1.kAcceptedParams]['indices.close'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? {
            ...userQuery
        } : {};
    ...
    async create(params, options) {
        const { path: acceptedPath, body: acceptedBody, query: acceptedQuery } = this[client_1.kAcceptedParams]['indices.create'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? {
            ...userQuery
        } : {};
    ...
    async createDataStream(params, options) {
        const { path: acceptedPath } = this[client_1.kAcceptedParams]['indices.create_data_stream'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? {
            ...userQuery
        } : {};
    ...
    async createFrom(params, options) {
        var _b;
        const { path: acceptedPath, body: acceptedBody, query: acceptedQuery } = this[client_1.kAcceptedParams]['indices.create_from'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? {
            ...userQuery
        } : {};
    ...
    async dataStreamsStats(params, options) {
        const { path: acceptedPath } = this[client_1.kAcceptedParams]['indices.data_streams_stats'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? {
            ...userQuery
        } : {};
    ...
    async delete(params, options) {
        const { path: acceptedPath } = this[client_1.kAcceptedParams]['indices.delete'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? {
            ...userQuery
        } : {};
    ...
    async deleteAlias(params, options) {
        const { path: acceptedPath } = this[client_1.kAcceptedParams]['indices.delete_alias'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? {
            ...userQuery
        } : {};
    ...
    async deleteDataLifecycle(params, options) {
        const { path: acceptedPath } = this[client_1.kAcceptedParams]['indices.delete_data_lifecycle'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? {
            ...userQuery
        } : {};
    ...
    async deleteDataStream(params, options) {
        const { path: acceptedPath } = this[client_1.kAcceptedParams]['indices.delete_data_stream'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? {
            ...userQuery
        } : {};
    ...
    async deleteDataStreamOptions(params, options) {
        const { path: acceptedPath } = this[client_1.kAcceptedParams]['indices.delete_data_stream_options'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? {
            ...userQuery
        } : {};
    ...
    async deleteIndexTemplate(params, options) {
        const { path: acceptedPath } = this[client_1.kAcceptedParams]['indices.delete_index_template'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? {
            ...userQuery
        } : {};
    ...
    async diskUsage(params, options) {
        const { path: acceptedPath } = this[client_1.kAcceptedParams]['indices.disk_usage'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? {
            ...userQuery
        } : {};
    ...
    async downsample(params, options) {
        var _b;
        const { path: acceptedPath, body: acceptedBody, query: acceptedQuery } = this[client_1.kAcceptedParams]['indices.downsample'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? {
            ...userQuery
        } : {};
    ...
    async exists(params, options) {
        const { path: acceptedPath } = this[client_1.kAcceptedParams]['indices.exists'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? {
            ...userQuery
        } : {};
    ...
    async existsAlias(params, options) {
        const { path: acceptedPath } = this[client_1.kAcceptedParams]['indices.exists_alias'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? {
            ...userQuery
        } : {};
    ...
    async existsIndexTemplate(params, options) {
        const { path: acceptedPath } = this[client_1.kAcceptedParams]['indices.exists_index_template'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? {
            ...userQuery
        } : {};
    ...
    async existsTemplate(params, options) {
        const { path: acceptedPath } = this[client_1.kAcceptedParams]['indices.exists_template'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? {
            ...userQuery
        } : {};
    ...
    async explainDataLifecycle(params, options) {
        const { path: acceptedPath } = this[client_1.kAcceptedParams]['indices.explain_data_lifecycle'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? {
            ...userQuery
        } : {};
    ...
    async fieldUsageStats(params, options) {
        const { path: acceptedPath } = this[client_1.kAcceptedParams]['indices.field_usage_stats'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? {
            ...userQuery
        } : {};
    ...
    async flush(params, options) {
        const { path: acceptedPath } = this[client_1.kAcceptedParams]['indices.flush'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? {
            ...userQuery
        } : {};
    ...
    async forcemerge(params, options) {
        const { path: acceptedPath } = this[client_1.kAcceptedParams]['indices.forcemerge'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? {
            ...userQuery
        } : {};
    ...
    async get(params, options) {
        const { path: acceptedPath } = this[client_1.kAcceptedParams]['indices.get'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? {
            ...userQuery
        } : {};
    ...
    async getAlias(params, options) {
        const { path: acceptedPath } = this[client_1.kAcceptedParams]['indices.get_alias'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? {
            ...userQuery
        } : {};
    ...
    async getDataLifecycle(params, options) {
        const { path: acceptedPath } = this[client_1.kAcceptedParams]['indices.get_data_lifecycle'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? {
            ...userQuery
        } : {};
    ...
    async getDataLifecycleStats(params, options) {
        const { path: acceptedPath } = this[client_1.kAcceptedParams]['indices.get_data_lifecycle_stats'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? {
            ...userQuery
        } : {};
    ...
    async getDataStream(params, options) {
        const { path: acceptedPath } = this[client_1.kAcceptedParams]['indices.get_data_stream'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? {
            ...userQuery
        } : {};
    ...
    async getDataStreamMappings(params, options) {
        const { path: acceptedPath } = this[client_1.kAcceptedParams]['indices.get_data_stream_mappings'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? {
            ...userQuery
        } : {};
    ...
    async getDataStreamOptions(params, options) {
        const { path: acceptedPath } = this[client_1.kAcceptedParams]['indices.get_data_stream_options'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? {
            ...userQuery
        } : {};
    ...
    async getDataStreamSettings(params, options) {
        const { path: acceptedPath } = this[client_1.kAcceptedParams]['indices.get_data_stream_settings'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? {
            ...userQuery
        } : {};
    ...
    async getFieldMapping(params, options) {
        const { path: acceptedPath } = this[client_1.kAcceptedParams]['indices.get_field_mapping'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? {
            ...userQuery
        } : {};
    ...
    async getIndexTemplate(params, options) {
        const { path: acceptedPath } = this[client_1.kAcceptedParams]['indices.get_index_template'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? {
            ...userQuery
        } : {};
    ...
    async getMapping(params, options) {
        const { path: acceptedPath } = this[client_1.kAcceptedParams]['indices.get_mapping'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? {
            ...userQuery
        } : {};
    ...
    async getMigrateReindexStatus(params, options) {
        const { path: acceptedPath } = this[client_1.kAcceptedParams]['indices.get_migrate_reindex_status'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? {
            ...userQuery
        } : {};
    ...
    async getTemplate(params, options) {
        const { path: acceptedPath } = this[client_1.kAcceptedParams]['indices.get_template'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? {
            ...userQuery
        } : {};
    ...
    async migrateReindex(params, options) {
        var _b;
        const { path: acceptedPath, body: acceptedBody, query: acceptedQuery } = this[client_1.kAcceptedParams]['indices.migrate_reindex'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? {
            ...userQuery
        } : {};
    ...
    async migrateToDataStream(params, options) {
        const { path: acceptedPath } = this[client_1.kAcceptedParams]['indices.migrate_to_data_stream'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? {
            ...userQuery
        } : {};
    ...
    async modifyDataStream(params, options) {
        const { path: acceptedPath, body: acceptedBody, query: acceptedQuery } = this[client_1.kAcceptedParams]['indices.modify_data_stream'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? {
            ...userQuery
        } : {};
    ...
    async open(params, options) {
        const { path: acceptedPath } = this[client_1.kAcceptedParams]['indices.open'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? {
            ...userQuery
        } : {};
    ...
    async promoteDataStream(params, options) {
        const { path: acceptedPath } = this[client_1.kAcceptedParams]['indices.promote_data_stream'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? {
            ...userQuery
        } : {};
    ...
    async putAlias(params, options) {
        const { path: acceptedPath, body: acceptedBody, query: acceptedQuery } = this[client_1.kAcceptedParams]['indices.put_alias'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? {
            ...userQuery
        } : {};
    ...
    async putDataLifecycle(params, options) {
        const { path: acceptedPath, body: acceptedBody, query: acceptedQuery } = this[client_1.kAcceptedParams]['indices.put_data_lifecycle'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? {
            ...userQuery
        } : {};
    ...
    async putDataStreamMappings(params, options) {
        var _b;
        const { path: acceptedPath, body: acceptedBody, query: acceptedQuery } = this[client_1.kAcceptedParams]['indices.put_data_stream_mappings'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? {
            ...userQuery
        } : {};
    ...
    async putDataStreamOptions(params, options) {
        const { path: acceptedPath, body: acceptedBody, query: acceptedQuery } = this[client_1.kAcceptedParams]['indices.put_data_stream_options'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? {
            ...userQuery
        } : {};
    ...
    async putDataStreamSettings(params, options) {
        var _b;
        const { path: acceptedPath, body: acceptedBody, query: acceptedQuery } = this[client_1.kAcceptedParams]['indices.put_data_stream_settings'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? {
            ...userQuery
        } : {};
    ...
    async putIndexTemplate(params, options) {
        const { path: acceptedPath, body: acceptedBody, query: acceptedQuery } = this[client_1.kAcceptedParams]['indices.put_index_template'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? {
            ...userQuery
        } : {};
    ...
    async putMapping(params, options) {
        const { path: acceptedPath, body: acceptedBody, query: acceptedQuery } = this[client_1.kAcceptedParams]['indices.put_mapping'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? {
            ...userQuery
        } : {};
    ...
    async putTemplate(params, options) {
        const { path: acceptedPath, body: acceptedBody, query: acceptedQuery } = this[client_1.kAcceptedParams]['indices.put_template'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? {
            ...userQuery
        } : {};
    ...
    async recovery(params, options) {
        const { path: acceptedPath } = this[client_1.kAcceptedParams]['indices.recovery'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? {
            ...userQuery
        } : {};
    ...
    async refresh(params, options) {
        const { path: acceptedPath } = this[client_1.kAcceptedParams]['indices.refresh'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? {
            ...userQuery
        } : {};
    ...
    async reloadSearchAnalyzers(params, options) {
        const { path: acceptedPath } = this[client_1.kAcceptedParams]['indices.reload_search_analyzers'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? {
            ...userQuery
        } : {};
    ...
    async removeBlock(params, options) {
        const { path: acceptedPath } = this[client_1.kAcceptedParams]['indices.remove_block'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? {
            ...userQuery
        } : {};
    ...
    async resolveCluster(params, options) {
        const { path: acceptedPath } = this[client_1.kAcceptedParams]['indices.resolve_cluster'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? {
            ...userQuery
        } : {};
    ...
    async resolveIndex(params, options) {
        const { path: acceptedPath } = this[client_1.kAcceptedParams]['indices.resolve_index'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? {
            ...userQuery
        } : {};
    ...
    async rollover(params, options) {
        const { path: acceptedPath, body: acceptedBody, query: acceptedQuery } = this[client_1.kAcceptedParams]['indices.rollover'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? {
            ...userQuery
        } : {};
    ...
    async segments(params, options) {
        const { path: acceptedPath } = this[client_1.kAcceptedParams]['indices.segments'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? {
            ...userQuery
        } : {};
    ...
    async shardStores(params, options) {
        const { path: acceptedPath } = this[client_1.kAcceptedParams]['indices.shard_stores'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? {
            ...userQuery
        } : {};
    ...
    async shrink(params, options) {
        const { path: acceptedPath, body: acceptedBody, query: acceptedQuery } = this[client_1.kAcceptedParams]['indices.shrink'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? {
            ...userQuery
        } : {};
    ...
    async simulateIndexTemplate(params, options) {
        var _b;
        const { path: acceptedPath, body: acceptedBody, query: acceptedQuery } = this[client_1.kAcceptedParams]['indices.simulate_index_template'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? {
            ...userQuery
        } : {};
    ...
    async simulateTemplate(params, options) {
        const { path: acceptedPath, body: acceptedBody, query: acceptedQuery } = this[client_1.kAcceptedParams]['indices.simulate_template'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? {
            ...userQuery
        } : {};
    ...
    async split(params, options) {
        const { path: acceptedPath, body: acceptedBody, query: acceptedQuery } = this[client_1.kAcceptedParams]['indices.split'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? {
            ...userQuery
        } : {};
    ...
    async stats(params, options) {
        const { path: acceptedPath } = this[client_1.kAcceptedParams]['indices.stats'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? {
            ...userQuery
        } : {};
    ...
    async updateAliases(params, options) {
        const { path: acceptedPath, body: acceptedBody, query: acceptedQuery } = this[client_1.kAcceptedParams]['indices.update_aliases'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? {
            ...userQuery
        } : {};
    ...
    async validateQuery(params, options) {
        const { path: acceptedPath, body: acceptedBody, query: acceptedQuery } = this[client_1.kAcceptedParams]['indices.validate_query'];
        const userQuery = params === null || params === void 0 ? void 0 : params.querystring;
        const querystring = userQuery != null ? {
            ...userQuery
        } : {};
...
exports.default = Indices; //# sourceMappingURL=indices.js.map
}),
];

//# sourceMappingURL=node_modules_%40elastic_elasticsearch_lib_api_api_indices_b585484f.js.map