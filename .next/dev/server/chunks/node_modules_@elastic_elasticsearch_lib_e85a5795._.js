module.exports = [
"[project]/node_modules/@elastic/elasticsearch/lib/sniffingTransport.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const transport_1 = __turbopack_context__.r("[project]/node_modules/@elastic/transport/index.js [app-route] (ecmascript)");
...
"[project]/node_modules/@elastic/elasticsearch/lib/helpers.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const tslib_1 = __turbopack_context__.r("[project]/node_modules/tslib/tslib.es6.mjs [app-route] (ecmascript)");
/* eslint-disable @typescript-eslint/naming-convention */ /* eslint-disable @typescript-eslint/promise-function-async */ /* eslint-disable @typescript-eslint/no-unnecessary-type-assertion */ const node_assert_1 = tslib_1.__importDefault(__turbopack_context__.r("[externals]/node:assert [external] (node:assert, cjs)"));
const timersPromises = tslib_1.__importStar(__turbopack_context__.r("[externals]/node:timers/promises [external] (node:timers/promises, cjs)"));
const node_stream_1 = __turbopack_context__.r("[externals]/node:stream [external] (node:stream, cjs)");
const transport_1 = __turbopack_context__.r("[project]/node_modules/@elastic/transport/index.js [app-route] (ecmascript)");
const Arrow_node_1 = __turbopack_context__.r("[project]/node_modules/apache-arrow/Arrow.node.js [app-route] (ecmascript)");
...
class Helpers {
     ...
     */ bulk(options, reqOptions = {}) {
        ...
        reqOptions.meta = true;
        const { datasource, onDocument, flushBytes = 5000000, flushInterval = 30000, concurrency = 5, retries = this[kMaxRetries], wait = 5000, onDrop = noop, // onSuccess does not default to noop, to avoid the performance hit
         ...
         */ async function iterate() {
            ...
            for await (const chunk of datasource){
                ...
                const [action, payload] = Array.isArray(result) ? result : [
                    result,
                    chunk
                ];
            ...
            async function onFlushTimeout() {
                ...
                try {
                    ...
                    /* istanbul ignore next */ helper.abort(); // eslint-disable-line
                }
            }
        }
        // This function builds a semaphore using the concurrency
...
"[project]/node_modules/@elastic/elasticsearch/lib/client.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const sniffingTransport_1 = tslib_1.__importDefault(__turbopack_context__.r("[project]/node_modules/@elastic/elasticsearch/lib/sniffingTransport.js [app-route] (ecmascript)"));
const helpers_1 = tslib_1.__importDefault(__turbopack_context__.r("[project]/node_modules/@elastic/elasticsearch/lib/helpers.js [app-route] (ecmascript)"));
const api_1 = tslib_1.__importDefault(__turbopack_context__.r("[project]/node_modules/@elastic/elasticsearch/lib/api/index.js [app-route] (ecmascript)"));
const package_json_1 = tslib_1.__importDefault(__turbopack_context__.r("[project]/node_modules/@elastic/elasticsearch/package.json (json)"));
const package_json_2 = tslib_1.__importDefault(__turbopack_context__.r("[project]/node_modules/@elastic/transport/package.json (json)"));
...
/* istanbul ignore next */ if (transportVersion.includes('-')) {
    // clean prerelease
...
class Client extends api_1.default {
    constructor(opts){
        ...
        const redaction = Object.assign({}, {
            type: 'replace',
            additionalKeys: []
        }, (_d = opts.redaction) !== null && _d !== void 0 ? _d : {});
        ...
        if (opts[kChild] !== undefined) {
            ...
            let nodeOptions = Array.isArray(nodes) ? nodes : [
                nodes
            ];
        ...
        let transportOptions = {
            ...
            /* eslint-disable-next-line @typescript-eslint/prefer-ts-expect-error */ // @ts-ignore enableMetaHeader will be available in transport v9.1.1
...
//# sourceMappingURL=node_modules_%40elastic_elasticsearch_lib_e85a5795._.js.map