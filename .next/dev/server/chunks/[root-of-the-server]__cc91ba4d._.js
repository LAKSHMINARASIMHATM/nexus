...
class SearchService {
    ...
    `;
        ...
        try {
            ...
            const totalCountRes = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].query("SELECT COUNT(*) FROM documents WHERE to_tsvector('english', title || ' ' || coalesce(meta_description, '')) @@ to_tsquery('english', $1)", [
                formattedQuery
            ]);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__cc91ba4d._.js.map